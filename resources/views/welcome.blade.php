...
<head>
    ...
    <!-- Animate.css -->
    <link rel="stylesheet" href="{{ asset('stamina/css/animate.css') }}">
    <!-- Icomoon Icon Fonts-->
    <link rel="stylesheet" href="{{ asset('stamina/css/icomoon.css') }}">
    <!-- Bootstrap  -->
    <link rel="stylesheet" href="{{ asset('stamina/css/bootstrap.css') }}">

    <!-- Magnific Popup -->
    <link rel="stylesheet" href="{{ asset('stamina/css/magnific-popup.css') }}">

    <!-- Owl Carousel  -->
    <link rel="stylesheet" href="{{ asset('stamina/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('stamina/css/owl.theme.default.min.css') }}">

    <!-- Theme style  -->
    <link rel="stylesheet" href="{{ asset('stamina/css/style.css') }}">

    <!-- Modernizr JS -->
    <script src="{{ asset('stamina/js/modernizr-2.6.2.min.js') }}"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
...
<body>
    ...
    <div id="page">
        <nav class="fh5co-nav" role="navigation">
            ...
            <div class="top-menu">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-2">
                            <div id="fh5co-logo"><a href="index.html">JustMove<span>.</span></a></div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 text-center animate-box">
                            <div class="services">
                                ...
                                <p><a href="#" class="btn btn-primary btn-outline btn-sm">More <i
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 animate-box">
                            <div class="trainer">
                                <a href="#"><img class="img-responsive" src="images/trainer-1.jpg"
                                        alt="trainer"></a>
                                <div class="title">
                        ...
                        <div class="col-md-4 col-sm-4 animate-box">
                            <div class="trainer">
                                <a href="#"><img class="img-responsive" src="images/trainer-2.jpg"
                                        alt="trainer"></a>
                                <div class="title">
                        ...
                        <div class="col-md-4 col-sm-4 animate-box">
                            <div class="trainer">
                                <a href="#"><img class="img-responsive" src="images/trainer-3.jpg"
                                        alt="trainer"></a>
                                <div class="title">
                        ...
                        <div class="fh5co-tabs">
                            <ul class="fh5co-tab-nav">
                                <li class="active"><a href="#" data-tab="1"><span
                                            class="visible-xs">S</span><span class="hidden-xs">Sunday</span></a></li>
                                ...
                                <div class="fh5co-tab-content tab-content active" data-tab-content="1">
                                    <ul class="class-schedule">
                                        <li class="text-center">
                                            <span><img src="images/exercise.svg" class="img-responsive"
                                                    alt=""></span>
                                        ...
                                        <li class="text-center">
                                            <span><img src="images/dumbbell.svg" class="img-responsive"
                                                    alt=""></span>
                                        ...
                                        <li class="text-center">
                                            <span><img src="images/yoga-carpet.svg" class="img-responsive"
                                                    alt=""></span>
                                        ...
                                        <li class="text-center">
                                            <span><img src="images/ballet.svg" class="img-responsive"
                                                    alt=""></span>
                                            <span class="time">7:00 AM - 8AM</span>
                                            <h4>Ballet Dance</h4>
                                            <small>Angel Adams</small>
                    ...
                    <div class="row row-bottom-padded-md">
                        <div class="col-lg-4 col-md-4">
                            <div class="fh5co-blog animate-box">
                                <a href="#"><img class="img-responsive" src="images/gallery-4.jpg"
                                        alt=""></a>
                                <div class="blog-text">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="fh5co-blog animate-box">
                                <a href="#"><img class="img-responsive" src="images/gallery-2.jpg"
                                        alt=""></a>
                                <div class="blog-text">
                                    <h3><a href=""#>45 Minimal Worksspace Rooms for Web Savvys</a></h3>
                                    <span class="posted_on">Sep. 15th</span>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="fh5co-blog animate-box">
                                <a href="#"><img class="img-responsive" src="images/gallery-3.jpg"
                                        alt=""></a>
                                <div class="blog-text">
                                    <h3><a href=""#>45 Minimal Worksspace Rooms for Web Savvys</a></h3>
                                    <span class="posted_on">Sep. 15th</span>
        ...
        <!-- jQuery -->
        <script src="{{ asset('stamina/js/jquery.min.js') }}"></script>
        <!-- jQuery Easing -->
        <script src="{{ asset('stamina/js/jquery.easing.1.3.js') }}"></script>
        <!-- Bootstrap -->
        <script src="{{ asset('stamina/js/bootstrap.min.js') }}"></script>
        <!-- Waypoints -->
        <script src="{{ asset('stamina/js/jquery.waypoints.min.js') }}"></script>
        <!-- Stellar Parallax -->
        <script src="{{ asset('stamina/js/jquery.stellar.min.js') }}"></script>
        <!-- Carousel -->
        <script src="{{ asset('stamina/js/owl.carousel.min.js') }}"></script>
        <!-- countTo -->
        <script src="{{ asset('stamina/js/jquery.countTo.js') }}"></script>
        <!-- Magnific Popup -->
        <script src="{{ asset('stamina/js/jquery.magnific-popup.min.js') }}"></script>
        <script src="{{ asset('stamina/js/magnific-popup-options.js') }}"></script>
        <!-- Main -->
        <script src="{{ asset('stamina/js/main.js') }}"></script>
